...
<div class="main-content">
    ...
    <div class="memo-wrapper">
        ...
        <div>
        <img src="<?= BASE_URL ?>/images/enblum.png"
            alt="Emblem"
            style="height:70px;">
        </div>
        ...
        <div class="memo-title">RETURN MEMO</div>

        <p>
            <strong>Sub:</strong> Return of Bill for Clarification / Remarks / Correction – Reg.
            <br><br>
            The below mentioned bill is returned herewith for necessary correction /
            remarks / clarification as mentioned below. Kindly do the needful and
            return the bill along with this return memo for further action.
        </p>
        ...
        <table class="memo-table mb-3">
            ...
            <tr>
                <th>4. Remarks</th>
                <td><?= htmlspecialchars($bill['Remarks']) ?></td>
            </tr>
             <tr>
                <th>4. Bill Amount</th>
        ...
        <form id="replyForm">
            ...
            <table class="memo-table">
                ...
                <tr>
                    <td><?= nl2br(htmlspecialchars($bill['ReasonForReturn'])) ?></td>
                    <td>
                        <textarea name="reply"
...
$('#replyForm').submit(function(e){
    ...
    $.post('returned_bill_reply_submit.php', $(this).serialize())
        .done(function(){
            Swal.fire('Success','Reply submitted successfully','success')
                .then(()=>window.location.href='returned_bill_memo.php');
        })
        .fail(function(){
